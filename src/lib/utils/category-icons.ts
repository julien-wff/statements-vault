...
// https://github.com/mayswind/ezbookkeeping/blob/d4d1342c705f65c555f9399497bd9241fee537d9/src/consts/icon.ts#L169C1-L169C62
...
export function getCategoryIcon(categoryId: string): string {
    const iconInfo = ALL_CATEGORY_ICONS[categoryId];
    return iconInfo ? iconInfo.icon : 'las la-question-circle';
}
